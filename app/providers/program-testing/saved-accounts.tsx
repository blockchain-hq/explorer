...
import type { SavedAccount } from '@/app/types/idl-types';
...
const SavedAccountsContext = createContext<SavedAccountsContextType | null>(null);
...
export const SavedAccountsProvider = ({ children }: { children: React.ReactNode }) => {
